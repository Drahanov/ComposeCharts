...
data class Frame(
    val start: FrameLine = FrameLine(),
    val end: FrameLine = FrameLine(),
    val bottom: FrameLine = FrameLine(),
    val top: FrameLine = FrameLine()
)
...
data class HorizontalLine(
    ...
    class Builder {
        ...
        private var labelAlignment: (Int) -> HorizontalLineAlignment =
